...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yozip KIICODE OFFC*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yopdf KIICODE OFFC*')
}
...
case 'kii':
var val = [
"_Hello My Name is KiiCodeOffc_",
"_Base Script : HwMods_",
"_Recode : Vallzoffc_",
"_Website api : https://kiicodeofficial.my.id/_",
...
if (!text) return reply(`Penggunaan Salah Harusnya ${prefix+command} vallzoffc`)
...
reply(`Wait 1-24 Jam an untuk proses banned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan Vallz Offc🥺🙏`)
...
reply(`Wait 1-24 Jam an untuk proses unbanned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan Vallz Offc🥺🙏`)
await loading(90000)
let payload = String(res.data)
if (payload.includes(`"payload":true`)) {
reply(`##- WhatsApp Support -##
...
"inviteExpiration": `MY NAME vall BOTZ${buttonkal}`,
"groupName": `MY NAME vall BOTZ${buttonkal}`,
"caption": `${buttonkal}`,
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY VALLZ OFFC MODS`);
});
}
...
case 'horrorblood':
case 'thunder':
	if (args.length == 0) return reply(`Example: ${prefix + command} VALLZ OFFC`)
	await loading()
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} VALLZ OFFC, 7, 7, 2005, Putri, 16, 11, 2004`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} VALLZ OFFC Hw`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} VALLZ OFFC, 7, 7, 2005`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} VALLZ OFFC|Putri`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} VALLZ OFFC, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} VALLZ OFFC, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
teksoooo = `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf VALLZ OFFC + sambil reply pesan target* \n\n Contoh 2 : yopdf VALLZ OFFC`
m.reply(teksoooo)
}
break
//=================================================//
...
teksooooo = `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip VALLZ OFFC + sambil reply pesan target* \n\n Contoh 2 : yozip VALLZ OFFC`
m.reply(teksooooo)
}
break
//=================================================//
...
teksoooooo = `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk VALLZ OFFC + sambil reply pesan target* \n\n Contoh 2 : yoapk VALLZ OFFC`
m.reply(teksoooooo)
}
break
//=================================================//
